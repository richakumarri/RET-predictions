...
create  table scratch.riders.prediction_query_day_level_train as
with base as
(
select
   ID
...
-- select count(*), count(distinct zone_code, order_month) from scratch.riders.prediction_query_day_level_train
